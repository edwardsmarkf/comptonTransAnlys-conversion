...
[root@localhost knex]# cat  clientStimword.*
#! /bin/bash -w
...
mariadb    --verbose  --execute="UPDATE comptonTransAnlys.clientContext SET clientContextErrorSpeakingCount= 1 WHERE contextAutoIncr=56 AND clientSessionAutoIncr=2349"                                                         ;       ##      TWELVE
mariadb --execute  "\. ./clientStimword.sql" ;

  ## new ball word "abc" into existing clientContext
node clientStimword.js '{"clientSessionAutoIncr" : 2349, "stimwordPositionAutoIncr" : 285, "clientContextError_OLD" :"", "clientContextError_NEW" : "abc"    , "clientStimwordNotes" : "notes ball word abc 285"}'              ;       ##      THIRTEEN
mariadb --execute  "\. ./clientStimword.sql" ;

  ## change ball word from "abc" to "def"
node clientStimword.js '{"clientSessionAutoIncr" : 2349, "stimwordPositionAutoIncr" : 285, "clientContextError_OLD" :"abc", "clientContextError_NEW" : "def" , "clientStimwordNotes" : "notes ball word abc -> def"}'           ;       ##      FOURTEEN
mariadb --execute  "\. ./clientStimword.sql" ;
