[root@localhost clientStimword]# clear
[root@localhost clientStimword]#
[root@localhost clientStimword]#
[root@localhost clientStimword]#
[root@localhost clientStimword]# cat  clientStimword.js
/*      clientStimword.js
...
console.info('000000000000000000000000000000000');
console.info(clientContextAutoIncr);
...
console.info('111111111111111111111111');
                                                console.info('Status of deleteClientStimword is: ' + val);
                                                return deleteChildlessClientContext(contextAutoIncr, clientContextAutoIncr, parmclientContextErrorSound_OLD)
                                        })
                                        .then( val =>   {
console.info('222222222222222222222222222222222222');
                                                console.info('Status of deleteClientClient is: ' + val);
                                                let retObj =
                                                        {       'status'                        :       1
...
processClientStimword(myArgs)
        .then(  (val)   =>      {
                console.info('YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY');
                console.info(val);
                console.info(JSON.stringify(val));
